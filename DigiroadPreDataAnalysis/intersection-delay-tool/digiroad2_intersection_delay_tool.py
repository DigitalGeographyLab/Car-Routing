...
def main():
    ...
    # =================
    #def main():
    base_dir = r"C:\HY-DATA\HENTENKA\KOODIT\Mapple\Projects\Turun_kaupunki\data"
    data_folder = os.path.join(base_dir, 'digiroad', 'merged')
    link_fp = os.path.join(data_folder, "DR_LINKKI_K_Turku_Foli_Region.shp")
    limits_fp = os.path.join(data_folder, "DR_NOPEUSRAJOITUS_K_Turku_Foli_Region.shp")
    signals_fp = os.path.join(data_folder, "DR_LIIKENNEVALO_Turku_Foli_Region.shp")
